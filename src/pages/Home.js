                              ...
                              <div className='w-full md:w-1/2 lg:w-1/3 p-3'>
                                          ...
                                          <form onSubmit={handleSubmit(onSubmit)}>
                                                <div className="my-2">
                                                      <input
                                                            ...
                                                            placeholder='Enter Customer Phone Number' autoComplete={`phone-number`} className='w-full p-2 border-2 border-violet-600 focus:outline-violet-800 rounded' min='0' type='number' {...register("phone", { required: true, pattern: /^01[3-9]\d{8}$/, maxLength: 11 })} />
                                                      <br />
...

                                                {
                                                      ...
                                                      <div className="my-2">
                                                            <input
                                                                  ...
                                                                  placeholder='Enter OTP' className='appearance-none mx-auto block w-1/4 p-2 border-2 border-violet-600 focus:outline-violet-800 rounded' type='number' />
                                                      </div>
                                                }

                                                {
                                                      isSmsSent ?
                                                            ...
                                                            <button
                                                                  ...
                                                                  type="submit" className='bg-violet-700 hover:bg-violet-800 text-white w-[100%] py-2 rounded-md'>Send SMS</button>
                                                }
                                          </form>
                                    </div>

                                    {
                                          ...
                                          <button
                                                ...
                                                type="submit" className='bg-violet-700 hover:bg-violet-800 text-white w-[100%] py-2 rounded-md'>Verify OTP</button>
                                    }
                              </div>
                        </div>
                  </div>
